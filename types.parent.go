...
type Parent struct {
	...
	DatabaseID uuid.UUID `json:"database_id" specific:"type"` // The ID of the database that this page belongs to.
	PageID     uuid.UUID `json:"page_id" specific:"type"`     // The ID of the page that this page belongs to.
	Workspace  bool      `json:"workspace" specific:"type"`   // Always true.
	BlockID    uuid.UUID `json:"block_id" specific:"type"`    // The ID of the page that this page belongs to.
}
