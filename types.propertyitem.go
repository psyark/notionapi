...
type PropertyItem struct {
	...
	Select         SelectPropertyItemData   `json:"select" specific:"type"`           // Select property value objects contain the following data within the select property:
	MultiSelect    []SelectPropertyItemData `json:"multi_select" specific:"type"`     // Multi-select property value objects contain an array of multi-select option values within the multi_select property.
	Date           DatePropertyItemData     `json:"date" specific:"type"`             // Date property value objects contain the following data within the date property:
	...
	CreatedBy      UserPropertyValueData    `json:"created_by" specific:"type"`       // Created by property value objects contain a user object within the created_by property. The user object describes the user who created this page.
	...
	LastEditedBy   UserPropertyValueData    `json:"last_edited_by" specific:"type"`   // Last edited by property value objects contain a user object within the last_edited_by property. The user object describes the user who last updated this page.
