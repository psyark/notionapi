...
type PropertyItem struct {
	...
	Relation       PageReference            `json:"relation" specific:"type"`         // Relation property value objects contain an array of relation property items with a pagereferences within the relation property. A page reference is an object with an id property, with a string value (UUIDv4) corresponding to a page ID in another database
