...
type PeopleFilterCondition struct {
	Contains       *uuid.UUID `json:"contains,omitempty"`         // Only return pages where the page property value contains the provided value.
	DoesNotContain *uuid.UUID `json:"does_not_contain,omitempty"` // Only return pages where the page property value does not contain the provided value.
	IsEmpty        bool       `json:"is_empty,omitempty"`         // Only return pages where the page property value is empty.
	IsNotEmpty     bool       `json:"is_not_empty,omitempty"`     // Only return pages where the page property value is present.
}
